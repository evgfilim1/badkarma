...
define aspara = Character("Аспара", color="#e3256b")  # цвет суеты рулит
define dub = Character("Дуб", color="#228b22")
define people = Character("Жители", color="#480607")
...
label start:
    ...
    "Пока вся деревня собиралась у дома старосты, и люди усаживались за большие столы вокруг
        ...
        последнюю тарелку с разнообразной едой на стол, после чего сразу уселся на свободное место
        рядом с жареным мясом Брамина."
    "Люди болтали между собой, медленно поднимался общий гул. После того как последний стул был
        занят, на небольшую сцену перед всеми, прихрамывая, вышел человек средних лет,
    ...
    "Родители, братья и сестры, дети... Люди гибнут почти каждый год по тем или иным причинам,
        кто-то от болезни, кто-то от голода. Но они не уходят от нас навсегда, природа всегда
        находится в балансе, отнимая жизнь, она дает жизнь чему-то новому."
    ...
    landa "Я хотела с ним поговорить, но подслушала, как они хотят убить тебя, пока ты не навредил
        всей деревне! Они говорили серьёзно, так что я думаю, они уже идут сюда. Давай быстрее!"
    sam "Что за каменная роза?"
    "Вскакивая с кровати всё же решил спросить я."
    landa "Не знаю, какая-то болезнь, они говорили что о ней забыли десятки лет назад. Я сразу
    ...
    "Самая светлая ночь в году и самая страшная для меня. Один день, способный изменить всю жизнь,
