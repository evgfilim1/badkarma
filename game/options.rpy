...
define config.version = "0.1.0-alpha.0"
...
Лицензировано под {a=https://www.apache.org/licenses/LICENSE-2.0}Apache License 2.0{/a}.
Исходный код доступен на {a=https://github.com/evgfilim1/badkarma}GitHub{/a}.
""")
...
define config.save_directory = "badkarma-1667376581"
